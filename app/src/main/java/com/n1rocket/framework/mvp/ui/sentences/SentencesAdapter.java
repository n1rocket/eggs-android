...
import com.n1rocket.framework.mvp.ui.base.BaseViewHolder;
...
/**
 * Created by n1rocketdev on 25-05-2017.
 */

public class SentencesAdapter extends RecyclerView.Adapter<BaseViewHolder> {
        ...
        switch (viewType) {
            case VIEW_TYPE_NORMAL:
                return new ViewHolder(
                        LayoutInflater.from(parent.getContext()).inflate(R.layout.item_sentences_view, parent, false));
